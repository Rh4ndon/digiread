    ...
    <section class="row">
                ...
                <div class="col-xl-12 col-md-6 col-sm-12">
                    <div class="card" id="demoStoryA">
                        ...
                        <div class="card-body">
                        <img src="assets/images/mila.jpg"  class="card-img-top img-fluid"
                            alt="singleminded">
                            <br><br>
                            <h4 class="card-title">Si Mila</h4>
                        ...
                        <p class="card-text" id="lyrics">
                        Marami ring halaman sa bukid. Maraming alagang hayop si Mila.
                        </p>
                        <p class="card-text" id="lyrics">
                        May alagang baboy si Mila. May alaga din siyang baka at kambing. Sa mga hayop niya, ang manok niya ang kanyang paborito. Tiko ang pangalan ng manok niya. Si Tiko ay kulay pula at puti. Siya ang gumigising kay Mila tuwing umaga. Masaya si Mila kapag naririnig ang tilaok ni Tiko.
                        </p>
                        <br>
