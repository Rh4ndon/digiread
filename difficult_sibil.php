    ...
    <section class="row">
                ...
                <div class="col-xl-12 col-md-6 col-sm-12">
                    <div class="card" id="demoStoryA">
                        ...
                        <div class="card-body">
                        <img src="assets/images/sibil.jpg"  class="card-img-top img-fluid"
                            alt="singleminded">
                            <br><br>
                            <h4 class="card-title">Karapatang Sibil</h4>
